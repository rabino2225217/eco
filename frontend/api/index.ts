...
async function getEntry() {
  if (!entryModule) {
    try {
      ...
      throw new Error(`Cannot load server module: ${importError instanceof Error ? importError.message : String(importError)}. Make sure the build completed successfully.`);
    }
  }
